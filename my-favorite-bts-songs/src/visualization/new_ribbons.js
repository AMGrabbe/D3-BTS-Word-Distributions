...
export function ribbon(headRadius) {
  ...
  function ribbon() {
    ...
    if (sa0 !== ta0 || sa1 !== ta1) {
      ...
      if ((da > -1 && da <= 0) || (da > 1 && da <= 2)) sweepflag = 1;
      else sweepflag = 0;
      context._ +=
        "A" +
        Math.abs(radI) +
  ...
  if (headRadius)
    ribbon.headRadius = function (_) {
      return arguments.length
        ? ((headRadius = typeof _ === "function" ? _ : constant(+_)), ribbon)
        : headRadius;
    };
  ...
  ribbon.sourceRadius = function (_) {
    return arguments.length
      ? ((sourceRadius = typeof _ === "function" ? _ : constant(+_)), ribbon)
      : sourceRadius;
  };

  ribbon.targetRadius = function (_) {
    return arguments.length
      ? ((targetRadius = typeof _ === "function" ? _ : constant(+_)), ribbon)
      : targetRadius;
  };
  ...
  ribbon.padAngle = function (_) {
    return arguments.length
      ? ((padAngle = typeof _ === "function" ? _ : constant(+_)), ribbon)
      : padAngle;
  };
